...
class Death(Scene):
  ...
  def enter(self):
    quips = [
      ...
      "You're worse then your dads jokes."
    ]
...
class CenteralCorridor(Scene):
  ...
  def enter(self):
    print(dedent("""
          ...
          from the Weapons Armory, put it in th bridge, and blow the ship
    ...
    if action == "shoot!":
      print(dedent("""
            ...
            Your laser hits his costume but misses him entriely.
      ...
      print(dedent("""
            ...
            fur fvgf nebhaq gur ubhfr.  The Gthon stops, tries
            not to laugh, then busts out laughing and can't move.
            While he's laughing you run up and shoot him square in
            head putting him down, then jump through the
            Weapon Armory door.
            """))
